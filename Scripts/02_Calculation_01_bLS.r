...
# Description: This script is made to run the bLSmodelR and tailored to the number cruncher of the University of Applied Sciences BFH. The code should also work on your computer but you have to adopt the number of cores.
#
...
N_traj <- 1E6
ncores <- 88 # numbers of cores used
MaxFetch <- 400
